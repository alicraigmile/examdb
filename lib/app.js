...
app.get('/qualifications/:qualification',function (req, res) {
    ...
    if ( ! qual )
	   return res.error.html(404,'qualification not found');
...
app.get('/courses/:course',function (req, res) {
    ...
    if ( ! course )
        res.error.html(404, 'course not found');
...
app.get('/programmesofstudy/:programmeofstudy',function (req, res) {
    ...
    if (! programmeofstudy)
        return res.error.html(404, 'programme of study not found');
...
app.get('/exams/:exam.json',function (req, res) {
    ...
    if ( ! exam )
        return res.error.text(404, 'The exam \''+examId+'\' was not found.');
...
app.get('/examboards/:examboard',function (req, res) {
    ...
    if ( ! examboard )
       return res.error.html(404,'examboard not found');
...
app.use(function(err, req, res, next) {
  ...
  console.error(err);
  res.error.html('internal server error');
})
