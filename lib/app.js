...
function loadSampleData() {
    Promise.all([
        models.Qualification.create({ name: 'GCSE' }),
        models.Qualification.create({ name: 'GCE' }),
        models.Qualification.create({ name: 'National 5' }),
        models.Qualification.create({ name: 'Higher' }),
        models.Qualification.create({ name: 'Advanced Higher' }),
        models.Qualification.create({ name: 'Nàiseanta 5' })
    ]);
    ...
    _.each(
        [
            {
                id: 'gcse-aqa-mathematics',
                provider: 'gcse-aqa',
                rogrammeofstudy: 'gcse-mathematics',
                bitesize: 'z8sg6fr'
            },
    ...
    _.each(
        [
            {
                id: 'gce-aqa-mathematics',
                course: 'gce-aqa-mathematics',
                paper: 'Mathematics',
                code: 'ALEVELM',
                date: '2018-07-23',
                timeofday: 'Morning',
            ...
            {
                id: 'gce-aqa-english-language',
                course: 'gce-aqa-english-language',
                paper: 'English Lang paper 1',
                code: 'ALEVELE',
                date: '2018-07-23',
                timeofday: 'Afternoon',
                duration: '2h',
            ...
            {
                id: 'gcse-aqa-mathematics-unit-1',
                course: 'gcse-aqa-mathematics',
                paper: 'Mathematics Unit 1 (Foundation & Higher)',
                code: 'A61UF',
                date: '2018-05-23',
                timeofday: 'Morning',
                duration: '1h 30m',
            ...
            {
                id: 'gcse-aqa-mathematics-unit-2',
                course: 'gcse-aqa-mathematics',
                paper: 'Mathematics Unit 2 (Foundation & Higher)',
                code: 'A62UF',
                date: '2018-05-24',
                timeofday: 'Morning',
                duration: '1h 30m',
            ...
            {
                id: 'gcse-aqa-mathematics-unit-3',
                course: 'gcse-aqa-mathematics',
                paper: 'Mathematics Unit 3 (Foundation & Higher)',
                code: 'A63UF',
                date: '2018-05-24',
                timeofday: 'Afternoon',
                duration: '1h 30m',
            ...
            {
                id: 'gcse-aqa-mathematics-unit-4',
                course: 'gcse-aqa-mathematics',
                paper: 'Mathematics Unit 4 (Foundation & Higher)',
                code: 'A64UF',
                date: '2018-05-25',
                timeofday: 'Morning',
                duration: '1h 45m',
            ...
            {
                id: 'gcse-aqa-home-economics-z1',
                course: 'gcse-aqa-home-economics',
                paper: 'Home Economics',
                code: 'GHE101',
                date: '2018/06/04',
                timeofday: 'Morning',
                duration: '1h',
...
app.get('/status', (req, res) => {
    const appName = npmPackage.name;
    const { version } = npmPackage.version;
    return res.json({ app: appName, version });
});
